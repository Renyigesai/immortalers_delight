...
public class PassSnifferCoolDownTrigger extends SimpleCriterionTrigger<PassSnifferCoolDownTrigger.Instance> {
    // 触发器唯一ID（需与进度JSON中的trigger字段一致）
    private static final ResourceLocation ID = new ResourceLocation(ImmortalersDelightMod.MODID, "pass_sniffer_cooldown");
