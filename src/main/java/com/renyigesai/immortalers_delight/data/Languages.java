...
public class Languages extends LanguageProvider {
    ...
    private void addEffects(){
        ...
        add("effect.immortalers_delight.burn_the_boats.description","When health drops below a certain percentage, grants buffs equivalent to Strength III, Swiftness III, Haste III, Jump Boost III, Resistance III.The health bar is partially overlaid by a shield and a blazing sword, with the covered portion marking the health threshold that triggers this effect.In Super Mode, this effect no longer conflicts with the aforementioned equivalent buffs. Additionally, when taking a fatal hit, you may consume this effect to avoid death.","在生命值低于一定比例时，提供相当于力量III、迅捷III、急迫III、跳跃提升III、抗性提升III的增益效果。使得生命条部分被盾牌与燃火的剑覆盖，覆盖的部分标记了触发该效果的生命值。超凡模式下不再与上述等效的效果互斥，且遭受致命攻击时，可以消耗此效果免死一次。");
        ...
        add("effect.immortalers_delight.smoke_abstinence.description","Prevents phantom spawns. While in the Nether: grants effects equivalent to Strength II, Haste III, Regeneration, Fire Resistance, and Resistance II. This effect is mutually exclusive with the aforementioned buffs.","阻止幻翼生成，在下界时：提供相当于力量II，急迫III，生命回复、抗火、抗性提升II的效果，与上述效果互斥。");
