...
//            .effect(() -> new MobEffectInstance(ImmortalersDelightMobEffect.RESISTANCE_TO_SURROUNDINGS.get(),4200),1F).alwaysEat().build();
    ...
    public static final FoodProperties TRAVEER = new FoodProperties.Builder().effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.INEBRIATED.get(),1200),1.0F).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.UNYIELDING.get(),4800,1),1.0F).alwaysEat().build();
    ...
    public static final FoodProperties JENG_NANU_SLICE = new FoodProperties.Builder()
            ...
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.PREHISTORIC_POWERS.get(),1400,1),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.INCANDESCENCE.get(),200,1),1f)
            .build();
    ...
    public static final FoodProperties JVAV_OFFEE = new FoodProperties.Builder()
            ...
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.SMOKE_ABSTINENCE.get(),9600),1f)
            .alwaysEat().build();
    public static final FoodProperties SEXTLOTUS_ROOT = new FoodProperties.Builder()
            .nutrition(3).saturationMod(0.5f)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),400),1.0F)
            .build();
    public static final FoodProperties SEXTLOTUS_ROOT_CUTS = new FoodProperties.Builder()
            .nutrition(2).saturationMod(0.3f)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),60,1),1.0F)
            .build();
    ...
    public static final FoodProperties OLD_BEIJING_CHICKEN_ROLL = new FoodProperties.Builder()
            ...
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.INCANDESCENCE.get(),1200,1),1.0F)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),1800,1),1.0F)
            .build();
    public static final FoodProperties SMASHED_SEXTLOTUS_ROOT = new FoodProperties.Builder()
            .nutrition(8).saturationMod(0.8f)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),2400),1.0F)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.COOL.get(),600,1),1.0F)
            .build();
    public static final FoodProperties OXYGRAPE = new FoodProperties.Builder()
            .nutrition(1).saturationMod(1.5f)
            .alwaysEat().fast()
    ...
    public static final FoodProperties GREEN_TEA_FIZZ = new FoodProperties.Builder()
            ...
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.INEBRIATED.get(),1800),1.0F)
            .build();
    public static final FoodProperties SEXTLOTUS_FIZZ = new FoodProperties.Builder()
            .alwaysEat()
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),8000,1),1.0F)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.INEBRIATED.get(),1800),1.0F)
            .build();
    public static final FoodProperties RAINBOW_FIZZ = new FoodProperties.Builder()
            ...
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),2400,1),1.0F)
            ...
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.INEBRIATED.get(),3000),1.0F)
            .build();
    public static final FoodProperties SPARROW_WINE = new FoodProperties.Builder()
            ...
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.WARM_CURRENT_SURGES.get(),800,2),1.0F)
            .effect(()->new MobEffectInstance(MobEffects.ABSORPTION,800,2),1.0F)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.INEBRIATED.get(),3800),1.0F)
            .build();
    ...
    public static final FoodProperties ICE_PIZZA = new FoodProperties.Builder().nutrition(3).saturationMod(0.5F).build();
    public static final FoodProperties TRAVA_BAO = new FoodProperties.Builder().nutrition(6).saturationMod(0.5F).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.UNYIELDING.get(),600),1f).build();
    public static final FoodProperties TRAVA_CONGEE = new FoodProperties.Builder().nutrition(6).saturationMod(0.5F).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.KEEP_A_FAST.get(),9600),1f).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.UNYIELDING.get(),1200),1f).build();
    public static final FoodProperties EIGHT_BERRY_TRAVARICE_CAKE = new FoodProperties.Builder().nutrition(6).saturationMod(0.5F).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.UNYIELDING.get(),3600),1f).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.RELIEVE_POISON.get(),3600,1),1f).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),3600),1f).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.CULTURAL_LEGACY.get(),3600,1),1f).build();
    public static final FoodProperties TRAVA_CALIFORNIA_ROLL = new FoodProperties.Builder().nutrition(6).saturationMod(0.5F)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.UNYIELDING.get(),3600),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),3600,1),1f)
            .build();
    public static final FoodProperties TRAVA_CALIFORNIA_ROLL_SLICE = new FoodProperties.Builder().nutrition(6).saturationMod(0.5F)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.UNYIELDING.get(),1200),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.MOONBRIGHT.get(),1200,1),1f)
            .build();

    public static final FoodProperties TRAVARICE_TEA = new FoodProperties.Builder().alwaysEat().build();

    public static final FoodProperties BAKED_OBSIDIAN_WALNUT = new FoodProperties.Builder()
            .nutrition(20).saturationMod(0.25f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.INFERNAL_FORGING.get(),1800,3),1f)
    ...
    public static final FoodProperties OBSIDIAN_KERNELCURD = new FoodProperties.Builder()
            .nutrition(12).saturationMod(0.25f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.COOL.get(),1200),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.SATIATED.get(),800),1f)
            .build();
    public static final FoodProperties OBSIDIAN_WALNUT_KERNEL = new FoodProperties.Builder()
            .nutrition(5).saturationMod(1)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.SATIATED.get(),100),1f)
            .build();
    public static final FoodProperties OBSIDIAN_WALNUT_MILK = new FoodProperties.Builder()
            .nutrition(10).saturationMod(0.25f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.SATIATED.get(),200),1f)
            .alwaysEat()
            .build();
    public static final FoodProperties SYRUP_WITH_KERNELCURD = new FoodProperties.Builder()
            .nutrition(10).saturationMod(1)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.COOL.get(),1000,1),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.INFERNAL_FORGING.get(),1000,2),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.RELIEVE_POISON.get(),3600,1),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.LET_IT_FREEZE.get(),1800),1f)
            .build();
    public static final FoodProperties WALNUT_ICECREAM = new FoodProperties.Builder()
            .nutrition(6).saturationMod(1)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.INFERNAL_FORGING.get(),3600,1),1f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.COOL.get(),1200),1f)
            .alwaysEat()
            .build();
