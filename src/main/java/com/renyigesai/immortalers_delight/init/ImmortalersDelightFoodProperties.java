...
public class ImmortalersDelightFoodProperties {
    ...
    public static final FoodProperties ROAST_EVOLUTCORN = new FoodProperties.Builder().nutrition(2)
            .saturationMod(1.5f).build();

    public static final FoodProperties EVOLUTCORN_GRAINS = new FoodProperties.Builder().nutrition(4)
    ...
    public static final FoodProperties POPOLUTCORN = new FoodProperties.Builder().nutrition(4).fast()
            .saturationMod(1.25f).effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.INCANDESCENCE.get(),600,0),1.0F).build();
