...
public class ImmortalersDelightFoodProperties {
    ...
    public static final FoodProperties PEATIC_MUSA_SALAD = new FoodProperties.Builder().nutrition(6).fast()
            ...
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),640,0),1.0F)
    ...
    public static final FoodProperties PEARLIP_PUMPKIN_PIE = new FoodProperties.Builder().fast()
            ...
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),360,0),1.0F)
            .build();
    ...
    public static final FoodProperties PEARLIPEARL_EGGSTEAM = new FoodProperties.Builder()
            .nutrition(2).saturationMod(2.0f)
    ...
    public static final FoodProperties PEARLIP_JELLY = new FoodProperties.Builder()
            ...
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),560,0),1.0F)
            .build();
    ...
    public static final FoodProperties ZEA_PANCAKE_SLICE = new FoodProperties.Builder()
            .nutrition(3).saturationMod(0.65f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.CULTURAL_LEGACY.get(),1200,0),1.0F)
    ...
    public static final FoodProperties PEARLIP_PIE_SLICE = new FoodProperties.Builder()
            .nutrition(4).saturationMod(0.475f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),450),1.0F)
    ...
    public static final FoodProperties HIMEKAIDO_YOGURT_PIE_SLICE = new FoodProperties.Builder()
            .nutrition(4).saturationMod(0.7375f)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.RELIEVE_POISON.get(),120,1),1.0F)
            .effect(()-> new MobEffectInstance(MobEffects.HEAL,1),1.0F)
            .build();
...
//            .effect(() -> new MobEffectInstance(ImmortalersDelightMobEffect.RESISTANCE_TO_SURROUNDINGS.get(),4200),1F).alwaysEat().build();
    ...
    public static final FoodProperties KWAT_WHEAT_DOUFU = new FoodProperties.Builder().nutrition(2).saturationMod(1.5F).effect(() ->new MobEffectInstance(MobEffects.DAMAGE_BOOST,400,1),1F).build();

    public static final FoodProperties FRY_KWAT_WHEAT_DOUFU = new FoodProperties.Builder().nutrition(4).saturationMod(1.0F)
    ...
    public static final FoodProperties KWAT_WHEAT_TOAST_SLICE = new FoodProperties.Builder().nutrition(4).saturationMod(0.6f).build();
    ...
    public static final FoodProperties NETHER_CREAM_BREAD = new FoodProperties.Builder().nutrition(8).saturationMod(0.375f)
            ...
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.SATIATED.get(),1200,1),1F).build();
    ...
    public static final FoodProperties MASHED_POISONOUS_POTATO_WITH_JAM = new FoodProperties.Builder().nutrition(6).saturationMod(1.25F)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.RESISTANCE_TO_ILLAGER.get(),2400),1F).build();

    public static final FoodProperties SUTFFED_KWAT_WHEAT_DOUFU = new FoodProperties.Builder().nutrition(9).saturationMod(0.65F)
    ...
    public static final FoodProperties ICE_PEARLIP = new FoodProperties.Builder().fast()
            ...
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),1800,0),1F)
    ...
    public static final FoodProperties CHOCOLATE_PEARLIP_STICKS = new FoodProperties.Builder().fast()
            .nutrition(4).saturationMod(0.5F)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.COOL.get(),800,0),1F)
            .effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),800,0),1F)
            .build();
    ...
    public static final FoodProperties BANANA_BOX_SALMON  = new FoodProperties.Builder().nutrition(7).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.WATER_BREATHING,600),1F).build();
    ...
    public static final FoodProperties PEARLIP_BUBBLE_MILK = new FoodProperties.Builder()
            .nutrition(4).saturationMod(0.5F)
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.VITALITY.get(),345,2),1.0F)
            .alwaysEat().build();
    ...
    public static final FoodProperties TROPICAL_FRUITY_CYCLONE_POWERED = new FoodProperties.Builder()
            ...
            .effect(()-> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN,5400,3),1.0F)
    ...
    public static final FoodProperties NETHER_CREAM_BREAD_POWERED = new FoodProperties.Builder()
            ...
            .effect(()-> new MobEffectInstance(ImmortalersDelightMobEffect.SATIATED.get(),1500,2),1F)
            .build();
    ...
    public static final FoodProperties LU_CHICKEN_LEGS  = new FoodProperties.Builder().nutrition(13).saturationMod(0.75f).effect(() -> new MobEffectInstance(ModEffects.COMFORT.get(),600),1f).effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.INCANDESCENCE.get(),600),1F).build();
    public static final FoodProperties NETHER_SOUP  = new FoodProperties.Builder().nutrition(13).saturationMod(0.75f).effect(() -> new MobEffectInstance(ImmortalersDelightMobEffect.INEBRIATED.get(),100),1f).effect(()->new MobEffectInstance(ImmortalersDelightMobEffect.DEEPNESS.get(),600),1F).build();
    public static final FoodProperties BRAISED_PORK  = new FoodProperties.Builder().nutrition(13).saturationMod(0.75f).effect(() -> new MobEffectInstance(ImmortalersDelightMobEffect.INCANDESCENCE.get(),1200),1f).effect(()->new MobEffectInstance(ModEffects.COMFORT.get(),1200),1F).build();
    public static final FoodProperties WARPED_LAUREL_CHICKEN_SOUP  = new FoodProperties.Builder().nutrition(13).saturationMod(0.75f).effect(() -> new MobEffectInstance(ImmortalersDelightMobEffect.DEEPNESS.get(),100),1f).effect(()->new MobEffectInstance(ModEffects.NOURISHMENT.get(),2400),1F).build();
    public static final FoodProperties APOLLYON_CAKE_ROLL  = new FoodProperties.Builder().nutrition(13).saturationMod(0.75f).effect(() -> new MobEffectInstance(ImmortalersDelightMobEffect.DEEPNESS.get(),6000),1f).effect(new  MobEffectInstance(MobEffects.DARKNESS,3600),1F).build();
}
