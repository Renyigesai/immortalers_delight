...
public class SkelverfishBomberModel<T extends Entity> extends EntityModel<T> {
    ...
    public SkelverfishBomberModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bodyPart_2 = partdefinition.addOrReplaceChild("bodyPart_2", CubeListBuilder.create().texOffs(28, 32).addBox(-3.0F, 0.0F, -1.5F, 6.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(40, 46).addBox(-1.0F, 1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(46, 37).addBox(-1.0F, 1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 20.0F, 1.0F));
