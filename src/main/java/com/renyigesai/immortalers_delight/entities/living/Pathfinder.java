...
public class Pathfinder extends SpellcasterIllager implements RangedAttackMob {
    ...
    public Pathfinder(EntityType<? extends Pathfinder> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new Pathfinder.PathfinderMirrorSpellGoal());
        this.goalSelector.addGoal(5, new Pathfinder.PathfinderBlindnessSpellGoal());
    ...
    class PathfinderBlindnessSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        public boolean canUse() {
            if (!super.canUse()) {
                return false;
            } else if (Pathfinder.this.getTarget() == null) {
                return false;
            } else if (Pathfinder.this.getTarget().getId() == this.lastTargetId) {
                return false;
            } else {
                return Pathfinder.this.level().getCurrentDifficultyAt(Pathfinder.this.blockPosition()).isHarderThan((float) Difficulty.NORMAL.ordinal());
            }
        }
        ...
        public void start() {
            super.start();
            LivingEntity livingentity = Pathfinder.this.getTarget();
        ...
        protected void performSpellCasting() {
            Pathfinder.this.getTarget().addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 400), Pathfinder.this);
        }
    ...
    class PathfinderMirrorSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        /**
         * Returns whether execution should begin. You can also read and cache any state necessary for execution in this
         * method as well.
         */
        public boolean canUse() {
            if (!super.canUse()) {
                ...
                return !Pathfinder.this.hasEffect(MobEffects.INVISIBILITY);
            }
        }
        ...
        protected void performSpellCasting() {
            Pathfinder.this.addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, 1200));
        }
