...
public class HotSpringEmiRecipe extends BasicEmiRecipe {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        // Texture output frame is 25x25 at (139,52); EMI large slot (26) aligns to that origin.
        widgets.addSlot(outputs.get(0), 139, 52).large(true).drawBack(false).recipeContext(this);
    }
}
